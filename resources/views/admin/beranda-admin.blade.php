            ...
            <div class="d-flex justify-content-between">
                <div>
                    <button type="button" class="btn btn-success btn-md" data-bs-toggle="modal"
                        data-bs-target="#pesanmodal"><span class="bi bi-plus-circle-fill"></span>&nbsp;Tambah
                        Pesanan</button>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card-img"
                                ...
                                <button type="button" class="btn btn-danger btn-md">
                                    <span class="bi bi-trash" data-bs-toggle="modal"
                                        data-bs-target="#hapusmodal"></span>
                                </button>
                            </div>
                            <h2 class="fw-normal mt-3">Kucing Pakai Jas</h2>
